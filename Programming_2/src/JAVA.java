...
public class JAVA {
 ...
 {
if(e instanceof LongServingEmployee)
 if(e.getEmployeeNumber()==number)
 {
 ((LongServingEmployee) e).getVacation();
 return true;
 }
     if(e instanceof FullTimeEmployee)
         if(e.getEmployeeNumber()==number)
         {
             ((FullTimeEmployee) e).getVacation();
         return true;
     }}
 return false;
 }
...
if(e.serving==false)
 ...
 if(e.getEmployeeNumber()==number)
 {
  ((LongServingEmployee) e).addVacation();
 return true;
 }
     if(e instanceof FullTimeEmployee)
         if(e.getEmployeeNumber()==number)
         {
             ((FullTimeEmployee) e).addVacation();
         return true;
     }}
 return false;
 }
